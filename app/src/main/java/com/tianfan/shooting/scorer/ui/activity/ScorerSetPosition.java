 ...
 * @CreateTime 2019-07-25 09:01
 * @Description 记分员设置靶位
 */
public class ScorerSetPosition extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (NewSPTools.getInstance().checktScorerePosition()){
            startActivity(new Intent(this, ScorerActivity.class));
            finish();
        }
    ...
    public void onClick(View v) {
        if (v.getId()==R.id.set_camera_bt){
            if (!shootPosition.equals("")){
                ...
                NewSPTools.getInstance().saveScorerePosition(shootPosition);
