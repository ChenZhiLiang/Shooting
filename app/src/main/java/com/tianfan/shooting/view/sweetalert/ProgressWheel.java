package com.tianfan.shooting.view.sweetalert;
...
public class ProgressWheel extends View {
    ...
    /**
     * Use onSizeChanged instead of onAttachedToWindow to get the dimensions of the com.hjt.jasonTools.view,
    ...
    /**
     * Parse the attributes passed to the com.hjt.jasonTools.view from the XML
     *
    ...
    /**
     * Puts the com.hjt.jasonTools.view on spin mode
     */
    public void spin() {
        lastTimeAnimated = SystemClock.uptimeMillis();
        isSpinning = true;
    ...
    // Great way to save a com.hjt.jasonTools.view's state http://stackoverflow.com/a/7089687/1991053
    @Override
